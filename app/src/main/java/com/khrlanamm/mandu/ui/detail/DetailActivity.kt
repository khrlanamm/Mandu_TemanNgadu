...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        } ?: return // Jika data null, hentikan activity
    ...
    private fun setupUserAccess() {
        ...
        if (AdminUID.isAdmin(currentUser?.uid)) {
            binding.switchHandled.visibility = View.VISIBLE
            binding.btnContactReporter.visibility = View.VISIBLE
            binding.btnCancelReport.visibility = View.GONE // Admin tidak bisa membatalkan
        } else {
    ...
    private fun setupActionListeners() {
        binding.apply {
            // Listener untuk switch (admin)
            switchHandled.setOnCheckedChangeListener(null) // Hapus listener sementara
            ...
            // Listener untuk tombol hubungi pelapor (admin)
            ...
            // Listener untuk tombol batalkan laporan (user)
                ...
                result.onSuccess { type ->
                    when (type) {
                        "Update berhasil" -> {
                            ...
                            // Jika status menjadi ditangani, sembunyikan tombol batal
                    ...
                    // Jika gagal update, kembalikan posisi switch
    ...
    private fun updateStatusUI(status: String) {
        report = report.copy(status = status) // Update local report data
